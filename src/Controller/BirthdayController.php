...
namespace Drupal\birthday\Controller;

use Drupal\Core\Controller\ControllerBase;
use Drupal\birthday\BirthdayStorage;
use Symfony\Component\DependencyInjection\ContainerInterface;

class BirthdayController extends ControllerBase {
  ...
  public function __construct() {
    $this->repository = new BirthdayStorage(\Drupal::database());
  }
  ...
  public function entryList() {
	...
	for($day = 1; $day < 32; $day++){
	  ...
	  foreach ($persons as $person) {
		...
		$isLecturer = $this->isLecturer($person);
  ...
  protected function isLecturer($person){
